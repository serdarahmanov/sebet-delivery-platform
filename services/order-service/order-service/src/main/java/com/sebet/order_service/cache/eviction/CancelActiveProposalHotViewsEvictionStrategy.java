...
public class CancelActiveProposalHotViewsEvictionStrategy implements CacheEvictionStrategy {

    public static final String CACHE_NAME = "CANCEL_ACTIVE_PROPOSAL_HOT_VIEWS";
