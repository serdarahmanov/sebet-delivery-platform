...
- scheduled-order behavior and activation-job settings
- proposal-timeout-job settings
...
Scheduled-order activation job settings:

```text
ORDER_SERVICE_SCHEDULED_ORDER_MIN_LEAD_TIME_MINUTES
ORDER_SERVICE_SCHEDULED_ORDER_SLOT_INTERVAL_MINUTES
ORDER_SERVICE_SCHEDULED_ORDER_DELIVERY_WINDOW_DURATION_MINUTES
ORDER_SERVICE_SCHEDULED_ORDER_MODIFICATION_CUTOFF_MINUTES
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_ENABLED
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_INTERVAL_MS
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_INITIAL_DELAY_MS
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_LEAD_TIME
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_BATCH_SIZE
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_LOCK_AT_MOST_FOR
ORDER_SERVICE_SCHEDULED_ORDER_ACTIVATION_JOB_LOCK_AT_LEAST_FOR
```

Proposal timeout job settings:

```text
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_ENABLED
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_INTERVAL_MS
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_INITIAL_DELAY_MS
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_RESPONSE_WINDOW
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_BATCH_SIZE
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_LOCK_AT_MOST_FOR
ORDER_SERVICE_PROPOSAL_TIMEOUT_JOB_LOCK_AT_LEAST_FOR
```
